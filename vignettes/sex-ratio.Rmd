...
bottom_5 <- extremes_2011 |> head(5) |> pull(state_name_harmonized)
top_5 <- extremes_2011 |> tail(5) |> pull(state_name_harmonized)
...
change_data <- census_population_time_series |>
  ...
  mutate(sex_ratio = 1000 * females / males) |>
  select(state_name, state_name_harmonized, year, sex_ratio) |>
