...
state_summary |> arrange(desc(sc_pct)) |> select(state_name_harmonized, sc_pct) |> head(5)

cat("\nStates with highest ST population %:\n")
state_summary |> arrange(desc(st_pct)) |> select(state_name_harmonized, st_pct) |> head(5)
```
